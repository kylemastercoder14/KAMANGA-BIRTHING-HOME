...
import { updateNoteColor, updateNotePin } from '@/actions';
    ...
    <div>
      ...
      <div className="p-3 border rounded-sm bg-accent">
        <div className="flex items-center gap-2">
          <div className="relative w-full bg-secondary flex items-center rounded-md border focus-within:ring-1 focus-within:ring-ring pl-2">
            <Search className="h-5 w-5 text-black" />
            <Input
              placeholder="Search notes..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="border-0 placeholder:text-black text-black focus-visible:ring-0 shadow-none"
            />
          </div>
              ...
              >
                ...
                <div className="border-t border-black/20 mt-3 pt-2 flex justify-between items-center">
                  <div className="flex gap-3 text-black/80">
                    <IconEdit className="size-4 cursor-pointer hover:text-black" />
                    {isPending ? (
                    ...
                    <IconDownload className="size-4 cursor-pointer hover:text-black" />
                    <IconShare className="size-4 cursor-pointer hover:text-black" />
                    <Popover>
                      <PopoverTrigger>
                        {isPending ? (
                          <Loader2 className="size-4 animate-spin" />
                    ...
                    <IconTrash className="size-4 cursor-pointer hover:text-black" />
                  </div>
                </div>
              </div>
            );
